...
import 'package:pet_manager/app/customs/permission_util.dart';
...
Future<List<XFile>> pickMultiImageXFile() async {
  bool status = false;
...
pmShowDatePicker(String title, Function(DateTime chooseDateTime) saveAction,
          ...
          child: Row(
            ...
            children: [
              ...
              TextButton(
                  ...
                  child: pmGetText("Save", textColor: PMColorUitl.mainGreen))
            ],
          ),
        ),
        pmDivider(),
