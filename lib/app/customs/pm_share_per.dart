...
class PMSharedPreferences {
  static PMSharedPreferences? _singleton;
  static SharedPreferences? _store;

  static Future<PMSharedPreferences?> initialize() async {
    if (_singleton == null) {
      if (_singleton == null) {
        var singleton = PMSharedPreferences._();
